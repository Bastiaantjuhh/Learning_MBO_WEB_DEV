	...
	var tocFlip = function() {
		if (getCookie("ciNav") == "yes") {
			...
			$(".wy-breadcrumbs").append(
				'<div style="float:right;"><div style="float:left;" id="topMenu">' +
					$(".wy-form")
						.parent()
						.html() +
					"</div></div>"
...
$(window).on("resize", function() {
	...
	if (getCookie("ciNav") == "yes" && $(window).width() <= 768) {
		// 768px is the tablet size defined by the theme
		$(".wy-nav-side").show();
	}
